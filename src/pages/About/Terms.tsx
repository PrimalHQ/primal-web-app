...
const sections: LegalSection[] = [
  {
    ...
    clauses: [
      ...
      {
        heading: 'Your Account Rights and Responsibilities',
        body: [
      ...
      {
        heading: 'Media storage limits for the Free Tier',
        body: [
  ...
  },
  {
    ...
    clauses: [
      {
        heading: 'Premium Service Definition',
        body: [
      ...
      {
        heading: 'Premium Service Duration',
        body: [
      ...
      {
        heading: 'Expired Premium Subscription',
        body: [
  ...
  },
  {
    ...
    clauses: [
      ...
      {
        heading: 'Maximum Wallet Balance',
        body: [
      ...
      {
        heading: 'Wallet Activation and Control',
        body: [
      ...
      {
        heading: 'Mistaken and Unauthorized Transactions',
        body: [
  ...
  {
    heading: 'Cancellation, Suspension, or Termination of Services',
    clauses: [
      {
  ...
  },
  {
    ...
    clauses: [
      {
        heading: 'CONSEQUENTIAL DAMAGES WAIVER',
        body: [
      ...
      {
        heading: 'BASIS OF BARGAIN AND FAILURE OF ESSENTIAL PURPOSE',
        body: [
  ...
  {
    heading: 'Changes to Agreement or Services',
    body: [
