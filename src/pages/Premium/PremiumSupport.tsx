    ...
    <div class={styles.supportLayout}>
      <div class={styles.supportContent}>
        ...
        <div class={styles.supportCard}>
          <img class={styles.starsImage} src={stars} alt="Five star rating" loading="lazy" decoding="async" />
        ...
        <div class={styles.supportCard}>
        <img class={styles.purpleCheckImage} src={purpleCheck} alt="Purple check icon" loading="lazy" decoding="async" />
          <div class={styles.title}>
        ...
        <div class={styles.supportCard}>
          <img class={styles.legendImage} src={legend} alt="Primal Legend badge" loading="lazy" decoding="async" />
          <div class={styles.title}>
