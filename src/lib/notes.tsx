...
export const isNoteMention = (url: string) => noteRegexLocal.test(url) && !isUrl(url);
export const isUserMention = (url: string) => profileRegex.test(url) && !isUrl(url);
export const isAddrMention = (url: string) => addrRegex.test(url) && !isUrl(url);
